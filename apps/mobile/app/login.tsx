...
const styles = StyleSheet.create({
  ...
  demoBrandRule: { color: colors.brass, fontSize: 8, fontWeight: '900', letterSpacing: 1.05 },
  demoHero: { gap: 4, marginTop: 2 },
  demoEyebrow: { color: colors.brass, fontSize: 8, fontWeight: '900', letterSpacing: 1.2 },
  ...
  demoImageDetail: { color: '#E8E1D3', fontSize: 9, fontWeight: '700' },
  demoVisualCaption: { backgroundColor: 'rgba(7, 8, 7, 0.78)', bottom: 6, color: '#E7E0D4', fontSize: 8, fontWeight: '800', letterSpacing: .45, paddingHorizontal: 5, paddingVertical: 2, position: 'absolute', right: 6 },
  ...
  accountSectionLabel: { color: colors.brass, fontSize: 8, fontWeight: '900', letterSpacing: 1.1 },
  ...
  primaryWorkspaceLabel: { color: '#FFF7E8', fontSize: 8, fontWeight: '900', letterSpacing: .9 },
