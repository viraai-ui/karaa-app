...
function DesktopMobileNotice() {
  return (
    <View accessibilityLabel="KARAA is designed for mobile" style={styles.desktopGate} testID="desktop-mobile-notice">
      <View style={styles.noticeMark}><Text style={styles.noticeMarkText}>K</Text></View>
      <Text style={styles.noticeBrand}>KARAA</Text>
...
const styles = StyleSheet.create({
  ...
  noticeBrand: { color: '#F5F1E8', fontSize: 17, fontWeight: '800', letterSpacing: 3 },
