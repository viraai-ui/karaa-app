...
const styles = StyleSheet.create({
  ...
  customerBottomNavigation: { minHeight: 67 }, customerTabLabel: { color: '#171717', fontSize: 9, fontWeight: '500' }, activeRail: { backgroundColor: '#B58A29', height: 2, left: 8, position: 'absolute', right: 8, top: -7 },
