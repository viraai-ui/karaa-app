  ...
  return (
    <View style={[styles.appBar, role === 'employee' && styles.employeeAppBar, healthcareBack && styles.healthcareAppBar, { paddingTop: insets.top }]} testID="demo-app-bar">
      <View style={styles.brandGroup}>
        ...
        <KaraaBrand height={healthcareBack ? 28 : role === 'employee' ? 37 : 26} variant={healthcareBack ? 'crown' : 'lockup'} />
      </View>
      <View style={[styles.topActions, role === 'employee' && styles.employeeTopActions]}>
...
const styles = StyleSheet.create({
  ...
  topActions: { alignItems: 'center', flexDirection: 'row', flexShrink:0 }, employeeTopActions: { justifyContent: 'space-between', marginRight: -5, width: 153 }, iconButton: { alignItems: 'center', height: 44, justifyContent: 'center', position: 'relative', width: 44 }, topIcon: { color: colors.paper, fontSize: 24, fontWeight: '300' }, notificationDot: { backgroundColor: '#E89A0A', borderColor: '#050605', borderRadius: 4, borderWidth: 1.5, height: 7, position: 'absolute', right: 8, top: 8, width: 7 }, avatarTarget: { alignItems: 'center', height: 44, justifyContent: 'center', width: 44 }, avatar: { alignItems: 'center', backgroundColor: '#474845', borderColor: '#686963', borderRadius: radii.pill, borderWidth: 1, height: 38, justifyContent: 'center', width: 38 }, avatarText: { color: colors.paper, fontSize: 10, fontWeight: '900' },
  ...
  employeeBottomNavigation: { borderRadius: 24, marginBottom: 4, marginHorizontal: 11, minHeight: 94 },
