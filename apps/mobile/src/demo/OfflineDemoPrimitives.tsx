...
const styles = StyleSheet.create({
  ...
  bottomNavigation: { backgroundColor: '#050605', bottom: 0, flexDirection: 'row', left: 0, minHeight: 75, paddingBottom: 8, paddingHorizontal: 2, paddingTop: 7, position: 'absolute', right: 0, zIndex: 10 }, tab: { alignItems: 'center', flex: 1, gap: 2, justifyContent: 'center', minHeight: 58, minWidth: 44, paddingHorizontal: 1 }, tabIcon: { color: '#D6D3CD', fontSize: 20, fontWeight: '500', lineHeight: 22 }, tabLabel: { color: '#D6D3CD', fontSize: 8, fontWeight: '700', lineHeight: 10, textAlign: 'center' },tabActive: { color: colors.brass },
