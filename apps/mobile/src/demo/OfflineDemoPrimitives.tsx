...
const styles = StyleSheet.create({
  ...
  bottomNavigation: { backgroundColor: '#050605', flexDirection: 'row', minHeight: 75, paddingBottom: 8, paddingHorizontal: 2, paddingTop: 7 }, tabWrapper: { flex: 1 }, tab: { alignItems: 'center', flex: 1, gap: 3, justifyContent: 'center', minHeight: 58 }, tabSelected: { backgroundColor: 'rgba(181, 138, 58, 0.10)', borderRadius: radii.sm }, tabIcon: { color: '#D6D3CD', fontSize: 21, fontWeight: '500', lineHeight: 23 }, tabLabel: { color: '#D6D3CD', fontSize: 8, fontWeight: '700', textAlign: 'center' },tabActive: { color: colors.brass },
