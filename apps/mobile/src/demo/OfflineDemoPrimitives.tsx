...
const styles = StyleSheet.create({
  appBar: { alignItems: 'center', backgroundColor: '#050605', borderBottomColor: colors.brass, borderBottomWidth: 1, flexDirection: 'row', justifyContent: 'space-between', minHeight: 62, paddingHorizontal: 8 },
