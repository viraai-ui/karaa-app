...
const styles = StyleSheet.create({
  ...
  projectIdentityEyebrow: { color: colors.brass, fontSize: 9, fontWeight: '900', letterSpacing: 0.8 },
  ...
  recordContext: { color: '#D6D3CD', fontSize: 9, fontWeight: '900', letterSpacing: 0.5, textTransform: 'uppercase' },
  ...
  factLabel: { color: '#D6D3CD', fontSize: 9, fontWeight: '900', letterSpacing: 0.5, textTransform: 'uppercase' },
