  ...
  return <View style={s.page} testID={`vertical-detail-${vertical.id}`}>
    <View style={s.hero} testID="vertical-hero">
      ...
      <View style={s.heroCopy}>
        <Text adjustsFontSizeToFit minimumFontScale={0.72} numberOfLines={3} style={s.heroTitle} testID="vertical-hero-title">{title}</Text>
