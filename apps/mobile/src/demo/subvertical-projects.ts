...
const healthcareProjects: PortfolioProject[] = [
  {
    ...
    status: "On Track",
    progress: 42,
    update: "OPD wing structural works underway",
    currentMilestone: "Structure",
    currentYear: "2026",
    stages: ["Planning ✓", "Structure 50%", "Closing Next", "Opening 2030"],
  ...
  },
  {
    ...
    status: "On Track",
    progress: 56,
    update: "NABH hospital block rising",
    currentMilestone: "Main Block",
    currentYear: "2025",
    stages: ["Design ✓", "Main Block 56%", "Façade", "Opening 2030"],
    completedActivity: "Substructure complete",
    openingYear: "2030",
    image: require("../../assets/verticals/conceptual-healthcare-campus.webp"),
  },
  {
