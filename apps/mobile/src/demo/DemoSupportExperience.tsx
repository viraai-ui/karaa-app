...
const styles = StyleSheet.create({
  ...
  supportCard: { alignItems: 'center', backgroundColor: '#FFFFFF', borderColor: '#E3E1DC', borderRadius: 12, borderWidth: 1, flexDirection: 'row', minHeight: 112, paddingHorizontal: 18, paddingVertical: 16 }, cardIcon: { alignItems: 'center', backgroundColor: '#F3E9D5', borderRadius: 25, height: 50, justifyContent: 'center', width: 50 }, cardIconText: { color: gold, fontSize: 22, fontWeight: '700' }, cardCopy: { flex: 1, marginHorizontal: 14 }, cardEyebrow: { color: gold, fontSize: 10, fontWeight: '900', letterSpacing: .8 }, cardTitle: { color: '#171815', fontFamily: 'serif', fontSize: 20, marginTop: 3 }, cardSubtitle: { color: '#6B6A64', fontSize: 11, lineHeight: 16, marginTop: 2 }, cardArrow: { color: gold, fontSize: 22 },
