...
const styles = StyleSheet.create({
  ...
  backArrow: { color: colors.brass, fontSize: 23, marginRight: 6 },
  backLabel: {
    color: "#EEE9DF",
    fontSize: 10,
    fontWeight: "800",
  ...
  subtitle: { color: "#5F5A52", fontSize: 10, lineHeight: 11, marginTop: 6 },
  summary: {
    backgroundColor: "#FFF",
    borderColor: "#E3E1DC",
    borderRadius: 4,
  ...
  metricLabel: { color: "#45423D", fontSize: 10, marginTop: 1 },
  ...
  chipActive: { backgroundColor: "#F6EEDC", borderColor: colors.brass },
  chipText: { color: "#55514A", fontSize: 10, fontWeight: "700" },
  ...
  location: { color: "#666159", fontSize: 10, marginTop: 2 },
  progressRow: {
    alignItems: "center",
    flexDirection: "row",
    gap: 7,
  ...
  statusText: { color: "#4C8651", fontSize: 10, fontWeight: "900" },
  statusProgressText: { color: "#477187" },
  update: { color: "#57534C", fontSize: 10, fontWeight: "700", marginTop: 2 },
  ...
  milestoneLabel: { color: "#555149", fontSize: 10, marginLeft: 5 },
  milestoneValue: {
    color: "#6B665D",
    fontSize: 10,
    fontWeight: "800",
  ...
  footerIcon: { color: "#B48227", fontSize: 10, marginRight: 4 },
  ...
  hPage: { backgroundColor: "#FFFFFF", marginHorizontal: -16, marginTop: -16, paddingBottom: 24 },
  ...
  hSummary: { backgroundColor: colors.paper, borderColor: colors.line, borderRadius: radii.sm, borderWidth: 1, flexDirection: "row", marginHorizontal: 16, marginTop: -17, minHeight: 70, ...cardShadow, zIndex: 3 },
  ...
  hList: { gap: 14 },
  hCard: { backgroundColor: colors.paper, borderColor: colors.line, borderRadius: radii.md, borderWidth: 1, overflow: "hidden" },
  ...
  hLocation: { color: "#A27625", fontSize: 10, fontWeight: "800", letterSpacing: .8 },
  ...
  hMetricCaption: { color: "#777168", fontSize: 10, fontWeight: "700" },
  ...
  hStageMarker: { color: "#9C7123", fontSize: 10, fontWeight: "900", letterSpacing: .65, marginLeft: "auto" },
