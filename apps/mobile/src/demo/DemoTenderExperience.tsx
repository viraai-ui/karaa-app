...
function TenderBoard({ onAction, onOpen, state, customer }: Pick<Props, 'onAction' | 'state'> & {onOpen:(id:string)=>void;customer:boolean}) {
  ...
  return (
    <View style={styles.tendersPage} testID="tenders-page">
      <View style={styles.tenderHero}><View style={styles.heroCopy}><Text style={styles.tenderEyebrow}>OPPORTUNITIES &amp; PROCUREMENT</Text><Text style={styles.tenderTitle}>Tenders</Text><Text style={styles.tenderSubtitle}>Track, manage and monitor every tender opportunity.</Text></View></View>
...
const styles = StyleSheet.create({
  ...
  customerOverviewCard:{backgroundColor:'#FBF7EE',borderColor:'#D9CBAF',borderWidth:1,shadowColor:'#5A4725'}, customerDarkText:{color:'#171713'}, customerMutedText:{color:'#77736C'}, customerMetric:{borderRightColor:'#DDD5C6'}, customerTotalLine:{borderTopColor:'#DDD5C6'}, overviewHead: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, overviewTitle: { color: '#F4EFE5', fontFamily: 'serif', fontSize: 16 }, dotsIcon:{flexDirection:'row',gap:3},
  metricGrid: { flexDirection: 'row', marginTop: 12 }, metric: { alignItems:'center',borderRightColor: '#494A45', borderRightWidth: 1, flex: 1, gap: 2, minWidth:0 },metricLast:{borderRightWidth:0}, metricValue: { color: '#F5F0E6', fontFamily: 'serif', fontSize: 20 }, metricLabel: { color: '#BDBAB2', fontSize: 9 }, totalLine: { alignItems: 'center', borderTopColor: '#494A45', borderTopWidth: 1, flexDirection: 'row', justifyContent: 'space-between', marginTop: 12, minHeight:48 },totalGroup:{alignItems:'center',flexDirection:'row'}, totalValue: { color: '#F5F0E6', fontFamily: 'serif', fontSize: 16 }, totalLabel: { color: '#A9A69F', fontSize: 9 }, cardLink: { color: '#A87920', fontSize: 10, fontWeight: '700' },linkTarget:{alignItems:'center',flexDirection:'row',justifyContent:'center',minHeight:44},
