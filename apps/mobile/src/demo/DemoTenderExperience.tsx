...
function LineIcon({name,light=false}:{name:string;light?:boolean}) { return <View accessibilityElementsHidden importantForAccessibility="no-hide-descendants" style={styles.iconCanvas}><View style={[styles.iconRing,light&&styles.iconLight,name==='search'&&styles.iconSearch,name==='check'&&styles.iconCheck]}/><View style={[styles.iconLine,light&&styles.iconLineLight,name==='filter'&&styles.iconFilter,name==='sort'&&styles.iconSort,name==='arrow'&&styles.iconArrow,name==='list'&&styles.iconList,name==='calendar'&&styles.iconCalendar,name==='document'&&styles.iconDocument,name==='building'&&styles.iconBuilding,name==='briefcase'&&styles.iconBriefcase]}/>{['energy','solar','gear','hourglass'].includes(name)?<><View style={[styles.iconRay,light&&styles.iconLineLight]}/><View style={[styles.iconRay,styles.iconRayTwo,light&&styles.iconLineLight]}/></>:null}</View>; }
...
const styles = StyleSheet.create({
  ...
  tendersPage: { gap: 12, paddingBottom: 4, position:'relative', width: '100%' },
  heroGrid:{backgroundColor:'#F7F2E8',height:105,left:0,opacity:.45,position:'absolute',right:0,top:-12},pylonOne:{borderColor:'#D9CEB9',borderRightWidth:1,height:120,position:'absolute',right:34,transform:[{rotate:'18deg'}],width:80},pylonTwo:{borderColor:'#DED4C2',borderTopWidth:1,height:70,position:'absolute',right:0,top:44,transform:[{rotate:'-12deg'}],width:150},
  tenderHero: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', minHeight:88, paddingTop: 4 },
  heroCopy: { flex: 1, gap: 1 }, heroButtons: { flexDirection: 'row', gap: 5 },
  tenderEyebrow: { color: '#A77B22', fontSize: 10, fontWeight: '900', letterSpacing: 1.05 },
  tenderTitle: { color: '#11120F', fontFamily: 'serif', fontSize: 34, lineHeight: 38 }, tenderSubtitle: { color: '#726F68', fontSize: 11 },
  squareButton: { alignItems: 'center', backgroundColor: '#111210', borderColor: '#373830', borderRadius: 4, borderWidth: 1, height: 44, justifyContent: 'center', width: 44 }, squareButtonLight: { backgroundColor: '#FFFEFA', borderColor: '#D8D3C9' }, pressed:{opacity:.62},
  iconCanvas:{height:22,position:'relative',width:22},iconRing:{borderColor:'#B88A31',borderRadius:8,borderWidth:1.5,height:14,left:4,position:'absolute',top:3,width:14},iconLight:{borderColor:'#FFF8E9'},iconLine:{backgroundColor:'#B88A31',height:1.5,left:14,position:'absolute',top:15,transform:[{rotate:'45deg'}],width:7},iconLineLight:{backgroundColor:'#FFF8E9'},iconSearch:{},iconCheck:{borderLeftWidth:0,borderTopWidth:0,borderRadius:0,height:8,transform:[{rotate:'45deg'}],width:5},iconFilter:{height:0,left:4,top:4,width:14,borderLeftColor:'transparent',borderLeftWidth:5,borderRightColor:'transparent',borderRightWidth:5,borderTopColor:'#B88A31',borderTopWidth:10,backgroundColor:'transparent'},iconSort:{height:14,left:10,top:4,width:2},iconArrow:{height:7,left:7,top:7,transform:[{rotate:'-45deg'}],width:7,borderRightColor:'#B88A31',borderRightWidth:1.5,borderBottomColor:'#B88A31',borderBottomWidth:1.5,backgroundColor:'transparent'},iconList:{height:12,left:4,top:5,width:14,borderBottomColor:'#B88A31',borderBottomWidth:1.5,borderTopColor:'#B88A31',borderTopWidth:1.5},iconCalendar:{height:15,left:3,top:4,width:16,borderColor:'#B88A31',borderWidth:1.5,backgroundColor:'transparent'},iconDocument:{height:16,left:5,top:3,width:12,borderColor:'#B88A31',borderWidth:1.5,backgroundColor:'transparent'},iconBuilding:{height:16,left:4,top:3,width:14,borderColor:'#B88A31',borderWidth:1.5,backgroundColor:'transparent'},iconBriefcase:{height:12,left:3,top:6,width:16,borderColor:'#B88A31',borderWidth:1.5,backgroundColor:'transparent'},iconRay:{backgroundColor:'#B88A31',height:1.5,left:2,position:'absolute',top:10,width:18},iconRayTwo:{transform:[{rotate:'90deg'}]},
  overviewCard: { backgroundColor: '#10110F', borderRadius: 7, overflow: 'hidden', paddingHorizontal: 14, paddingTop: 14 }, overviewHead: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, overviewTitle: { color: '#F7F2E8', fontFamily: 'serif', fontSize: 17 }, dotsIcon:{flexDirection:'row',gap:3},
  metricGrid: { flexDirection: 'row', marginTop: 12 }, metric: { alignItems:'center',borderRightColor: '#343530', borderRightWidth: 1, flex: 1, gap: 3 },metricLast:{borderRightWidth:0}, metricValue: { color: '#F5F0E6', fontFamily: 'serif', fontSize: 21 }, metricLabel: { color: '#BDBAB2', fontSize: 10 }, totalLine: { alignItems: 'center', borderTopColor: '#343530', borderTopWidth: 1, flexDirection: 'row', justifyContent: 'space-between', marginTop: 12, paddingVertical: 10 },totalGroup:{alignItems:'center',flexDirection:'row',gap:7}, totalValue: { color: '#F5F0E6', fontFamily: 'serif', fontSize: 18 }, totalLabel: { color: '#A9A69F', fontSize: 10 }, cardLink: { color: '#D1A84C', fontSize: 11, fontWeight: '700' },linkTarget:{alignItems:'center',flexDirection:'row',justifyContent:'center',minHeight:44},
  searchTools: { flexDirection: 'row', gap: 6 }, tenderSearch: { alignItems: 'center', backgroundColor: '#FFFEFA', borderColor: '#D8D3C9', borderRadius: 4, borderWidth: 1, flex: 1, flexDirection: 'row', height: 44, paddingHorizontal: 10 }, tenderSearchInput: { color: '#11120F', flex: 1, fontSize: 12, height: 42, paddingHorizontal: 7, paddingVertical: 0 },
  chipRail: { flexDirection: 'row', gap: 4 }, chip: { alignItems: 'center', borderColor: '#D5D0C6', borderRadius: 16, borderWidth: 1, flex: 1, height: 28, justifyContent: 'center' }, chipActive: { backgroundColor: '#111210', borderColor: '#111210' }, chipLabel: { color: '#69665F', fontSize: 10, fontWeight: '700' }, chipLabelActive: { color: '#F7F2E8' },
  headingBlock: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, headingCopy:{flex:1,minWidth:0,paddingRight:4}, serifSection: { color: '#161713', fontFamily: 'serif', fontSize: 20 },sectionSubtitle:{color:'#817C73',fontSize:10,marginTop:2}, sectionLink: { color: '#A77B22', fontSize: 11, fontWeight: '700' },
  appliedCard: { backgroundColor: '#FFFEFA', borderColor: '#DDD8CE', borderRadius: 5, borderWidth: 1, paddingHorizontal: 8 }, progressRow: { alignItems:'center', borderBottomColor:'#E9E4DA', borderBottomWidth:1, flexDirection:'row', minHeight:58,paddingVertical:6 },lastRow:{borderBottomWidth:0}, appliedIcon:{alignItems:'center',backgroundColor:'#F1ECE1',borderRadius:4,height:38,justifyContent:'center',marginRight:8,width:38}, progressCopy:{flex:1,gap:2,minWidth:0}, progressHeading: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, progressName: { color: '#2B2B27', flex: 1, fontSize: 12, fontWeight: '700' }, progressOwner:{color:'#858078',fontSize:10}, progressPercent: { color: '#3A3934', fontSize: 10, fontWeight: '900',marginLeft:4 }, progressBottom:{alignItems:'center',flexDirection:'row',gap:7}, progressStage:{color:'#A77B22',fontSize:10,maxWidth:150}, slimRail: { backgroundColor: '#E6E1D7', borderRadius: 2, flex:1, height: 4, overflow: 'hidden' }, slimFill: { backgroundColor: '#BE9136', height: 4 },
  ...
  tenderList: {}, compactRow: { alignItems: 'center', borderBottomColor: '#DDD8CE', borderBottomWidth: 1, flexDirection: 'row', minHeight: 76, paddingVertical: 8 },comfortableRow:{minHeight:94,paddingVertical:12}, sectorIcon: { alignItems: 'center', backgroundColor: '#F1ECE1', borderRadius: 4, height: 42, justifyContent: 'center', marginRight: 9, width: 42 }, compactCopy: { flex: 1, gap: 2,minWidth:0 }, compactTitle: { color: '#1A1B17', fontFamily: 'serif', fontSize: 14,lineHeight:17 }, compactMeta: { color: '#827E76', fontSize: 10 }, compactFacts: { flexDirection: 'row', gap: 9, marginTop: 3 }, factSmall: { color: '#8A867E', fontSize: 10,flexShrink:1 }, factStrong: { color: '#2F302B', fontWeight: '800' }, rowSide: { alignItems: 'flex-end', gap: 7, marginLeft: 5 }, statusBadge: { backgroundColor: '#F0E7D4', borderRadius: 8, color: '#8B661E', fontSize: 9, fontWeight: '800', overflow: 'hidden', paddingHorizontal: 6, paddingVertical: 3 }, goldArrowButton: { alignItems: 'center', backgroundColor: '#B98C31', borderRadius: 3, height: 32, justifyContent: 'center', width: 36 }, emptyResults: { color: '#77736C', fontSize: 11, paddingVertical: 20, textAlign: 'center' },
  deadlineStrip: { alignItems: 'center', backgroundColor: '#F0E8D8', borderLeftColor: '#B98C31', borderLeftWidth: 3, borderRadius: 3, flexDirection: 'row', minHeight: 68, paddingHorizontal: 9 }, calendarIcon: { alignItems: 'center', backgroundColor: '#111210', borderRadius: 3, height: 40, justifyContent: 'center', marginRight: 8, width: 40 }, deadlineCopy: { flex: 1, gap: 1,minWidth:0 }, deadlineEyebrow: { color: '#A77B22', fontSize: 9, fontWeight: '900', letterSpacing: .6 }, deadlineTitle: { color: '#20211D', fontSize: 11, fontWeight: '800' }, deadlineMeta: { color: '#716D65', fontSize: 10 }, deadlineLink: { color: '#8C661D', fontSize: 10, fontWeight: '800', textDecorationLine: 'underline' },calendarTarget:{alignItems:'center',flexDirection:'row',minHeight:44},
  modalShade: { alignItems: 'center', backgroundColor: 'rgba(0,0,0,.55)', bottom: 0, justifyContent: 'center', left: 0, padding: 16, position: 'absolute', right: 0, top: 0 }, modalCard: { backgroundColor: '#FBF8F0', borderRadius: 8, gap: 8, maxWidth: 350, padding: 16, width: '100%' }, modalEyebrow: { color: '#A77B22', fontSize: 9, fontWeight: '900', letterSpacing: 1 }, modalTitle: { color: '#141511', fontFamily: 'serif', fontSize: 23 }, modalCopy: { color: '#625F58', flexShrink:1,fontSize: 12, lineHeight: 20 }, prototypeNote: { color: '#8C661D', fontSize: 10, fontStyle: 'italic', lineHeight: 15 }, modalClose: { alignItems: 'center', backgroundColor: '#121310', borderRadius: 4, flex:1,justifyContent: 'center', minHeight: 44, marginTop: 5 }, modalCloseText: { color: '#F8F3E8', fontSize: 11, fontWeight: '800' },modalStats:{flexDirection:'row',justifyContent:'space-between',paddingVertical:12},modalStatValue:{color:'#A77B22',fontFamily:'serif',fontSize:22},modalStatLabel:{color:'#625F58',fontSize:10},calendarRow:{alignItems:'center',borderBottomColor:'#DED7CA',borderBottomWidth:1,flexDirection:'row',gap:8,minHeight:50},fieldLabel:{color:'#A77B22',fontSize:10,fontWeight:'900',letterSpacing:.8,marginTop:4},modalOptions:{flexDirection:'row',flexWrap:'wrap',gap:6},modalOption:{alignItems:'center',borderColor:'#D1C9BB',borderRadius:22,borderWidth:1,justifyContent:'center',minHeight:44,paddingHorizontal:11},modalOptionOn:{backgroundColor:'#EDE0C6',borderColor:'#A77B22'},optionText:{color:'#292A26',fontSize:11,fontWeight:'700'},modalActions:{flexDirection:'row',gap:8},modalSecondary:{alignItems:'center',borderColor:'#CFC6B6',borderRadius:4,borderWidth:1,flex:1,justifyContent:'center',minHeight:44,marginTop:5},closeTarget:{alignItems:'center',justifyContent:'center',minHeight:44},closeText:{color:'#6D685F',fontSize:11,fontWeight:'700',textDecorationLine:'underline'},
  page: { gap: spacing.sm },
