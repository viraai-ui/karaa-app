...
const styles = StyleSheet.create({
  ...
  overviewCard: { backgroundColor: '#292A26', borderRadius: 4, justifyContent:'space-between', maxHeight:170, minHeight:150, overflow: 'hidden', paddingHorizontal: 12, paddingTop: 10 }, overviewHead: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, overviewTitle: { color: '#F4EFE5', fontFamily: 'serif', fontSize: 15 }, dotsIcon:{flexDirection:'row',gap:3},
